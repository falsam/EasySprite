...
(function(){
	...
	// Screen - Crée et ouvre un nouvel écran  - Create and open new screen.
	function openScreen(id, x, y, width, height, callBack, refreshRate) {
		...
		// Activation de la procédure de mise à jour de la scéne	
		if (callBack != void 0) {
	...
	// Screen - Efface la totalité de l'écran avec la couleur html spécifiée 
	function clearScreen(color) {
		game.context.fillStyle = color;
		game.context.fillRect(0, 0, game.width, game.height);
	}

	// Screen - Retourne la largeur de l'écran
	function screenWidth() {
		return game.width;
	}

	// Screen - Retourne la hauteur de l'écran
	...
	function createSprite(width, height, color) {
		...
		sprite.rotate.angle = 0;
		sprite.rotate.relatif = false;
		sprite.rotate.vAngle = 0;
		...
		// Flip default
		sprite.flip.h = 1; // No flip (-1 flip)
		sprite.flip.v = 1; // no flip (-1 flip)
	...
	// sprite - Chargement d'un sprite - Load sprite
	//          Width 	: Largeur Image
	...
	// Sprite - Copier un sprite
	function copySprite (sprite) {
		return Object.assign({}, sprite);
	}

	// Sprite - Definir l'opacité - define opacity(0.0 et 1.0)
	...
	// Sprite - Définition du point d'ancrage
	...
	// Sprite - Affichage en position x et y
	//   		Width : Largeur du sprite (Optionelle)
	//			Height: Hauteur du sprite (Optionelle) 
	...
	// Sound - Charge le son (Wav, mp3, ...)
	function loadSound(FileName) {
		return new Howl({ src: [FileName] });
	}

	// Sound - Change le volume entre 0.0 et 1.0
...
// Map use jahashtable.js Version 3.0
